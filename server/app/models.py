...
class Customer(Base):
    ...
    shipping_method = Column(String(120), nullable=True)
    payment_terms = Column(String(100), nullable=True)
    upload_to_peach = Column(Boolean, nullable=False, default=False)
...
class Supplier(Base):
    ...
    vendor_number = Column(String(100), nullable=True, index=True)
    name = Column(String(200), nullable=False)
    ...
    notes = Column(Text, nullable=True)
    ap_default_expense_account_id = Column(Integer, ForeignKey("accounts.id"), nullable=True)
    ap_default_inventory_clearing_account_id = Column(Integer, ForeignKey("accounts.id"), nullable=True)
    ap_default_tax_account_id = Column(Integer, ForeignKey("accounts.id"), nullable=True)
    ap_default_freight_account_id = Column(Integer, ForeignKey("accounts.id"), nullable=True)
    ap_auto_approve_threshold = Column(Numeric(14, 2), nullable=True, default=Decimal("0"))
    ap_amount_tolerance = Column(Numeric(14, 2), nullable=True, default=Decimal("0"))
    ap_quantity_tolerance_pct = Column(Numeric(9, 4), nullable=True, default=Decimal("0"))
    ap_requires_three_way_match = Column(Boolean, nullable=False, default=True)
    ap_duplicate_check_mode = Column(String(30), nullable=False, default="WARN")
    created_at = Column(DateTime, default=datetime.utcnow, nullable=False)
    updated_at = Column(DateTime, default=datetime.utcnow, onupdate=datetime.utcnow, nullable=False)
...
class Item(Base):
    ...
    monument_type = Column(String(100), nullable=True)
    lr_feet = Column(Numeric(14, 2), nullable=True)
    lr_inches = Column(Numeric(14, 2), nullable=True)
    fb_feet = Column(Numeric(14, 2), nullable=True)
    fb_inches = Column(Numeric(14, 2), nullable=True)
    tb_feet = Column(Numeric(14, 2), nullable=True)
    tb_inches = Column(Numeric(14, 2), nullable=True)
    ...
    purchase_description = Column(Text, nullable=True)
    unit_price = Column(Numeric(14, 2), nullable=False)
    cost_price = Column(Numeric(14, 2), nullable=True)
    weight_lbs = Column(Numeric(14, 2), nullable=True)
    location = Column(String(255), nullable=True)
    peach_id = Column(String(100), nullable=True)
    new_code = Column(String(100), nullable=True)
    ...
    exclude_from_price_list = Column(Boolean, default=False, nullable=False)
    upload_to_peach = Column(Boolean, default=False, nullable=False)
    item_type = Column(String(100), nullable=True)
    inventory_check = Column(Boolean, default=False, nullable=False)
