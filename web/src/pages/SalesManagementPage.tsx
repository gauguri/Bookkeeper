...
export default function SalesManagementPage() {
  ...
  return (<div className="space-y-6">
    <header className="flex flex-wrap items-center justify-between gap-3"><div><h2 className="text-2xl font-semibold">Sales Command Center</h2><p className="text-sm text-muted">End-to-end sales lifecycle from accounts to cash.</p></div><div className="flex flex-wrap gap-2"><Link className="app-button-secondary" to="/sales/accounts/new">New account</Link><Link className="app-button-secondary" to="/sales/opportunities/new">New opportunity</Link><Link className="app-button-secondary" to="/sales/quotes/new">New quote</Link><Link className="app-button-secondary" to="/sales/orders/new">New order</Link></div></header>
